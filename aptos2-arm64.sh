...
then
    ...
    curl -SL https://github.com/docker/compose/releases/download/v2.6.0/docker-compose-linux-aarch64 -o ~/.docker/cli-plugins/docker-compose
...
#wget -P $HOME/aptos https://api.ondex.app/aptos/seeds.yaml
